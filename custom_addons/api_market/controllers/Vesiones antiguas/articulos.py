...
class SecondMarketArticleController(http.Controller):
    """Controlador para gestión de artículos"""
    ...
    @http.route('/api/articles', type='json', auth='public', methods=['GET'], csrf=False, cors='*')
    ...
    @http.route('/api/articles/<int:article_id>', type='json', auth='public', methods=['GET'], csrf=False, cors='*')
    ...
    @http.route('/api/articles', type='json', auth='public', methods=['POST'], csrf=False, cors='*')
    ...
    @http.route('/api/articles/<int:article_id>', type='json', auth='public', methods=['PUT'], csrf=False, cors='*')
    ...
    @http.route('/api/articles/<int:article_id>/publish', type='json', auth='public', methods=['POST'], csrf=False, cors='*')
    ...
    @http.route('/api/articles/<int:article_id>', type='json', auth='public', methods=['DELETE'], csrf=False, cors='*')
    ...
    @http.route('/api/articles/my-articles', type='json', auth='public', methods=['GET'], csrf=False, cors='*')

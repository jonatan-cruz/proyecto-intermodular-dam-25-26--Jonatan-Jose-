...
class SecondMarketChatController(http.Controller):
    ...
    @http.route('/api/chats', type='json', auth='public', methods=['POST'], csrf=False, cors='*')
    ...
    @http.route('/api/chats', type='json', auth='public', methods=['GET'], csrf=False, cors='*')
    ...
    @http.route('/api/chats/<int:chat_id>/messages', type='json', auth='public', methods=['GET'], csrf=False, cors='*')
    ...
    @http.route('/api/chats/<int:chat_id>/messages', type='json', auth='public', methods=['POST'], csrf=False, cors='*')
...
class SecondMarketReportController(http.Controller):
    ...
    @http.route('/api/reports', type='json', auth='public', methods=['POST'], csrf=False, cors='*')
    ...
    @http.route('/api/reports/my-reports', type='json', auth='public', methods=['GET'], csrf=False, cors='*')
...
class SecondMarketCategoryController(http.Controller):
    ...
    @http.route('/api/categories', type='json', auth='public', methods=['GET'], csrf=False, cors='*')
    ...
    @http.route('/api/categories/<int:category_id>/articles', type='json', auth='public', methods=['GET'], csrf=False, cors='*')
    ...
    @http.route('/api/tags', type='json', auth='public', methods=['GET'], csrf=False, cors='*')

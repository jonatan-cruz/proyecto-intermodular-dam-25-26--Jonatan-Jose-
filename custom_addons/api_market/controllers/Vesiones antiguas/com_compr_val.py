...
class SecondMarketCommentController(http.Controller):
    ...
    @http.route('/api/comments', type='json', auth='public', methods=['POST'], csrf=False, cors='*')
    ...
    @http.route('/api/comments/<int:comment_id>/read', type='json', auth='public', methods=['POST'], csrf=False, cors='*')
    ...
    @http.route('/api/comments/<int:comment_id>', type='json', auth='public', methods=['DELETE'], csrf=False, cors='*')
    ...
    @http.route('/api/comments/received', type='json', auth='public', methods=['GET'], csrf=False, cors='*')
...
class SecondMarketPurchaseController(http.Controller):
    ...
    @http.route('/api/purchases', type='json', auth='public', methods=['POST'], csrf=False, cors='*')
    ...
    @http.route('/api/purchases/<int:purchase_id>/confirm', type='json', auth='public', methods=['POST'], csrf=False, cors='*')
    ...
    @http.route('/api/purchases/<int:purchase_id>/cancel', type='json', auth='public', methods=['POST'], csrf=False, cors='*')
    ...
    @http.route('/api/purchases/my-purchases', type='json', auth='public', methods=['GET'], csrf=False, cors='*')
    ...
    @http.route('/api/purchases/my-sales', type='json', auth='public', methods=['GET'], csrf=False, cors='*')
...
class SecondMarketRatingController(http.Controller):
    ...
    @http.route('/api/ratings', type='json', auth='public', methods=['POST'], csrf=False, cors='*')
    ...
    @http.route('/api/ratings/user/<int:user_id>', type='json', auth='public', methods=['GET'], csrf=False, cors='*')
